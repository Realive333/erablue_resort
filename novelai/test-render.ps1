...
try {
    ...
    foreach ($name in 'NAI_項目', 'NAI_キャラ番号', 'NAI_キャラ行', 'OPTION_NOVELAI', 'NAI_設定値', 'NAI_設定更新', 'OPTION_NOVELAI_CONFIG') {
...
'@
    ...
    Write-Host 'PASS: Emuera character IDs / settings parse / HTML_PRINT / disabled / pending / image / escaped status'
}
finally {
